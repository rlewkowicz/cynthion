...
class CynthionPlatformRev1D4(CynthionPlatform):
    ...
    resources   = [
        ...
        *LEDResources(pins="E13 C13 B14 A15 D12 C11", attrs=Attrs(IO_TYPE="LVCMOS33"), invert=True),
        ...
        # Resource("ram1", 0,
        #     Subsignal("clk",   DiffPairs("J3", "K3", dir="o"), Attrs(IO_TYPE="LVCMOS33D")),
        #     Subsignal("dq",    Pins("L1 M1 N1 P1 Q1 R1 S1 T1", dir="io")),
        #     Subsignal("rwds",  Pins("U1", dir="io")),
        #     Subsignal("cs",    PinsN("V1", dir="o")),
        #     Subsignal("reset", PinsN("W1", dir="o")),
        #     Attrs(IO_TYPE="LVCMOS33", SLEWRATE="FAST")
        # ),
